...
class ListMapDay14 extends StatefulWidget {
  ListMapDay14({super.key});

  @override
  State<ListMapDay14> createState() => _ListMapDay14State();
}

class _ListMapDay14State extends State<ListMapDay14> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Tarot dan Artinya")),
        ...
        itemBuilder: (context, index) {
          return Card(
            ...
            child: ListTile(
              leading: SizedBox(
                child: Image.asset(
                  "assets/cards/${dataAlat[index]["img"]}",
                  width: 50,
                  height: 50,
                  fit: BoxFit.cover,
                ),
              ),
              title: Text(dataAlat[index]["name"] ?? ""),
              subtitle: Text(dataAlat[index]["fortune_telling"][0] ?? ""),
            ),
          );
        },
      ),
